...
function get_protocol(addElements){
...
function get_product(addElements){
	$.getJSON($SCRIPT_ROOT + '/protocol/get_product',{
		...
		protocol.sourceProduct.capacity = Number(data.result[0]["capacity_value"]) == 0 ? Number(data.result[0]["capacity"]).toFixed(3) : Number(data.result[0]["capacity"] * 1000).toFixed(3);	
...
function get_sorting(addElements){
...
function get_accept(addElements){
...
function get_reject(addElements){
...
function get_component(addElements){
...
function get_requirements(addElements){
	$.post($SCRIPT_ROOT + '/protocol/requirements/get_requirements',{
		...
		get_requirements_fractions(addElements);
	})
	.fail(function(jqXHR, exception){
		var msg = "Status Error: " + jqXHR.status + "; exeption: " + exception + "; responseText: " + jqXHR.responseText;
		ErrorLog(msg, false);
...
function get_requirements_fractions(addElements){
	$.getJSON($SCRIPT_ROOT + '/protocol/requirements/get_fraction',{
		...
		get_requirements_components(addElements);
	})
	.fail(function(jqXHR, exception){
		var msg = "Status Error: " + jqXHR.status + "; exeption: " + exception + "; responseText: " + jqXHR.responseText;
		ErrorLog(msg, false);
...
function get_requirements_components(addElements){
